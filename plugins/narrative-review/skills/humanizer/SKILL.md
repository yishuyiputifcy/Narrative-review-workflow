...
When installed from the `narrative-review` plugin, its explicit Codex invocation name is `$narrative-review:humanizer`. Its existing natural-language invocation rules remain unchanged.
